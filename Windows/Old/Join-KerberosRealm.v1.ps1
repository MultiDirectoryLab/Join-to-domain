...
function Join-KerberosRealm {
    ...
    $realmName = Read-Host "Enter realm name (e.g., EXAMPLE.COM)"
...
"@
    ...
    try {
        ...
        Write-Host "  - Principal may already exist" -ForegroundColor Gray
...
function Restart-System {
    ...
    $confirm = Read-Host "Are you sure you want to reboot now? (yes/no)"
